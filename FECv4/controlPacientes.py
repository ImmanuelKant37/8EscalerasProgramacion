...
def buscar_por_atributo():
    ...
    if atributo == "Medico":
        print()         #CONTINUAR ACA
    if atributo != 'Fecha' and atributo!="Medico":
        ...
        for persona in personas:
            if persona[atributo] == valor:
                ...
                if (atributo=="Nombre"):
                    apellido, dni, fecha, nacionalidad= persona["Apellido"],persona["Documento"],persona["Fecha"],persona["Nacionalidad"]
                elif(atributo=="Apellido"):
                    nombre, dni, fecha, nacionalidad= persona["Nombre"],persona["Documento"],persona["Fecha"],persona["Nacionalidad"]
                elif(atributo=="Documento"):
                    apellido, nombre,fecha , nacionalidad =persona["Apellido"],persona["Nombre"],persona["Fecha"],persona["Nacionalidad"]
                elif(atributo=="Fecha"):
                    apellido, dni, nombre, nacionalidad= persona["Apellido"],persona["Documento"],persona["Nombre"],persona["Nacionalidad"]
                elif(atributo=="Nacionalidad"):
                    apellido, dni, fecha, nombre=persona["Apellido"],persona["Documento"],persona["Fecha"],persona["Nombre"]
